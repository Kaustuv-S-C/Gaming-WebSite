...
//Variáveis do jogo
var canvas, context, LARGURA, ALTURA, img, GameStatus = 0,
    record, GRAVITY = 2,
    life = 3,
    score = 0,
    aux = 0,
...
function play() {
    ...
    if (GameStatus == Status.start) {
        ...
        canvas.onclick = function(event) {
            ...
            GRAVITY = 2;
            elementSort();
            alert("Hey, in this game you must select the element that is presented by the cat (on the left side of the screen). You initially have three lives, and as you let a presented element pass by, you lose a life. For each element you get right, a point!\n\nHave fun! :)\n\nDeveloped by Legends")
