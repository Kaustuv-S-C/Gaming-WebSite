...
const noEmissive = 0x000000,
    possibleEmissive = 0x003300,
    dangerEmissive = 0x660000,
    selectedEmissive = 0x000066,
    selectableEmissive = 0x003333,
    hintEmissive = 0x660066;
const noColor = 0x000000,
    possibleColor = 0x00ff00,
    dangerColor = 0xff0000,
    selectedColor = 0x0000ff,
    selectableColor = 0x00ffff,
    hintColor = 0xff00ff;
const possibleMat = new Set(),
    dangerMat = new Set(),
    selectedMat = new Set(),
    selectableMat = new Set(),
    hintMat = new Set();
const highlightDuration = 0.15,
    moveDuration = 0.2;
